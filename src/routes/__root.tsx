...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Gabriele's Golden Voice — Professional AI Voice Experiences" },
      { name: "description", content: "Artificial intelligence with the elegance of a human voice. Premium voice experiences for every business need." },
      { name: "author", content: "Gabriele's Golden Voice" },
      { property: "og:title", content: "Gabriele's Golden Voice — Professional AI Voice Experiences" },
      { property: "og:description", content: "Artificial intelligence with the elegance of a human voice. Premium voice experiences for every business need." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Gabriele's Golden Voice — Professional AI Voice Experiences" },
      { name: "twitter:description", content: "Artificial intelligence with the elegance of a human voice. Premium voice experiences for every business need." },
